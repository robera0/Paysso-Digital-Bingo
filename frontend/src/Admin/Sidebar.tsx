...
export const Sidebar: React.FC<SidebarProps> = ({ currentTab, onSelectTab }) => {
  ...
  return (
    <aside className="hidden md:flex flex-col w-[250px] bg-[#121215]/95 backdrop-blur-2xl border-r border-[#26262a] h-screen sticky left-0 top-0 z-40 select-none shadow-2xl shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="bg-[#1868DB]/25 text-[#60a5fa] text-[9px] font-extrabold px-1.5 py-0.5 rounded-md border border-[#1868DB]/50 shadow-[0_0_10px_rgba(24,104,219,0.3)]">
                ADMIN
              </span>
            </div>
            <span className="text-[10px] text-[#8e8e93] font-medium tracking-wider uppercase block mt-0.5">
              Digital Bingo Control
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-[#26262a]/80">
        <div className="bg-[#18181c]/90 rounded-2xl p-3.5 border border-[#26262a] flex items-center gap-3 shadow-inner">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between">
              <p className="text-[11px] font-bold text-white tracking-tight">System Operational</p>
              <Activity className="w-3.5 h-3.5 text-[#10B981]" />
            </div>
            <p className="text-[10px] text-[#8e8e93] font-mono mt-0.5">Core v2.4.0 • Active</p>
          </div>
        </div>
      </div>
    </aside>
