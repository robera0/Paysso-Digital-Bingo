    ...
    <div className="p-3.5 sm:p-6 md:p-8 w-full max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-[#8e8e93] mt-1 font-medium">
            Real-time platform metrics, live counters, and recent activity telemetry.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-b from-[#18181c] to-[#141416] border border-[#26262a] rounded-2xl p-5 relative overflow-hidden shadow-sm hover:border-[#1868DB]/50 hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(24,104,219,0.15)] transition-all duration-200 group">
          <div className="flex items-center justify-between text-[#8e8e93] mb-3">
            <span className="text-xs font-bold uppercase tracking-wider text-[#a1a1a5]">Total Revenue</span>
        ...
        <div className="bg-gradient-to-b from-[#18181c] to-[#141416] border border-[#26262a] rounded-2xl p-5 relative overflow-hidden shadow-sm hover:border-[#10B981]/50 hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(16,185,129,0.15)] transition-all duration-200 group">
          <div className="flex items-center justify-between text-[#8e8e93] mb-3">
            <span className="text-xs font-bold uppercase tracking-wider text-[#a1a1a5]">Active Users</span>
        ...
        <div className="bg-gradient-to-b from-[#18181c] to-[#141416] border border-[#26262a] rounded-2xl p-5 relative overflow-hidden shadow-sm hover:border-[#F59E0B]/50 hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(245,158,11,0.15)] transition-all duration-200 group">
          <div className="flex items-center justify-between text-[#8e8e93] mb-3">
            <span className="text-xs font-bold uppercase tracking-wider text-[#a1a1a5]">Live Games</span>
          ...
          <div className="text-2.5xl font-black font-mono text-white tracking-tight">
            4 <span className="text-sm text-[#8e8e93] font-normal">Active</span>
          </div>
          <div className="mt-3 flex items-center gap-2 text-xs">
        ...
        <div className="bg-gradient-to-b from-[#18181c] to-[#141416] border border-[#26262a] rounded-2xl p-5 relative overflow-hidden shadow-sm hover:border-[#3b82f6]/50 hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(59,130,246,0.15)] transition-all duration-200 group">
          <div className="flex items-center justify-between text-[#8e8e93] mb-3">
            <span className="text-xs font-bold uppercase tracking-wider text-[#a1a1a5]">Tickets Sold</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#161618] border border-[#26262a] rounded-2xl p-5 space-y-4 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-sm font-bold text-white uppercase tracking-wider font-sans">Revenue Analytics</h2>
              <p className="text-xs text-[#8e8e93] mt-0.5">Hourly ticket disbursement volume across all games</p>
            </div>
            <div className="flex items-center gap-1 bg-[#121214] p-1 rounded-xl border border-[#26262a]">
              <span className="px-2.5 py-1 rounded-lg bg-[#1868DB] text-white text-[10px] font-bold shadow-sm">24H</span>
              <span className="px-2.5 py-1 rounded-lg text-[#8e8e93] text-[10px] font-semibold hover:text-white cursor-pointer transition-colors">7D</span>
              <span className="px-2.5 py-1 rounded-lg text-[#8e8e93] text-[10px] font-semibold hover:text-white cursor-pointer transition-colors">30D</span>
            </div>
          </div>
            ...
            {[35, 48, 62, 45, 80, 95, 70, 88, 65, 92, 100, 84].map((h, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-2">
                <div
                  ...
                  style={{ height: `${h}%` }}
                />
                <span className="text-[9px] text-[#8e8e93] font-mono">{i * 2}:00</span>
              </div>
            ))}
          </div>
          ...
          <div className="flex items-center justify-between text-xs text-[#8e8e93] pt-1">
            <span className="flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-sm bg-[#1868DB]" /> Peak Traffic: 20:00 UTC ($42,100)
            </span>
            <span className="font-mono text-white font-semibold">Average: $26,450/hr</span>
          </div>
        </div>

        {/* Quick Actions & System Health */}
        <div className="bg-[#161618] border border-[#26262a] rounded-2xl p-5 space-y-4 shadow-sm">
          <h2 className="text-sm font-bold text-white uppercase tracking-wider font-sans">Quick Management</h2>
          <div className="space-y-2.5">
            <button className="w-full p-3 bg-[#121214] hover:bg-[#1c1c20] rounded-xl border border-[#26262a] flex items-center justify-between text-left transition-all group cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-white">Create New Raffle</p>
                  <p className="text-[10px] text-[#8e8e93]">Setup prize pools and limits</p>
                </div>
              </div>
            ...
            <button className="w-full p-3 bg-[#121214] hover:bg-[#1c1c20] rounded-xl border border-[#26262a] flex items-center justify-between text-left transition-all group cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#8e8e93]">Manage limits and permissions</p>
                </div>
              </div>
              <ChevronRight className="w-4 h-4 text-[#8e8e93] group-hover:text-white group-hover:translate-x-0.5 transition-all" />
            </button>
            ...
            <button className="w-full p-3 bg-[#121214] hover:bg-[#1c1c20] rounded-xl border border-[#26262a] flex items-center justify-between text-left transition-all group cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-white">Financial Audit</p>
                  <p className="text-[10px] text-[#8e8e93]">Generate revenue reconciliation</p>
                </div>
              </div>
              <ChevronRight className="w-4 h-4 text-[#8e8e93] group-hover:text-white group-hover:translate-x-0.5 transition-all" />
            </button>
      ...
      <div className="bg-[#161618] border border-[#26262a] rounded-2xl overflow-hidden shadow-sm">
        <div className="p-5 border-b border-[#26262a] flex items-center justify-between">
          <div>
            <h2 className="text-sm font-bold text-white uppercase tracking-wider font-sans">Live Telemetry Feed</h2>
            <p className="text-xs text-[#8e8e93] mt-0.5">Real-time operational events and system actions</p>
          </div>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3.5 min-w-0">
                  <div className={`w-9 h-9 rounded-xl border flex items-center justify-center ${item.iconBg} shrink-0`}>
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[11px] text-[#8e8e93] mt-0.5 truncate">{item.subtitle}</p>
                  </div>
                </div>
                <span className="text-[11px] text-[#8e8e93] font-mono whitespace-nowrap shrink-0">{item.time}</span>
              </div>
            );
          })}
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-[#161618] border border-[#26262a] rounded-2xl w-full max-w-md overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            <div className="p-4 border-b border-[#26262a] bg-[#121214] flex items-center justify-between">
              <h3 className="text-sm font-bold text-white">Event Telemetry Log</h3>
              <button
            ...
            <div className="p-5 space-y-3 text-xs">
              <div className="p-3.5 bg-[#121214] rounded-xl border border-[#26262a]">
                <span className="text-[10px] text-[#8e8e93] uppercase block font-semibold">Event</span>
                <p className="text-sm font-bold text-white mt-1">{selectedEvent.title}</p>
                <p className="text-xs text-[#8e8e93] mt-0.5">{selectedEvent.subtitle}</p>
              </div>
              <div className="flex justify-between py-2 border-b border-[#26262a]">
                <span className="text-[#8e8e93]">Timestamp:</span>
                <span className="text-white font-mono">{selectedEvent.time}</span>
              </div>
              <div className="flex justify-between py-2 border-b border-[#26262a]">
                <span className="text-[#8e8e93]">Status Flag:</span>
                <span className="text-[#10B981] font-mono font-semibold">{selectedEvent.badge}</span>
              </div>
              <div className="flex justify-between py-2">
                <span className="text-[#8e8e93]">Verification:</span>
                <span className="text-[#3b82f6] font-mono">0x74a...88cc (SHA256)</span>
              </div>
            </div>
